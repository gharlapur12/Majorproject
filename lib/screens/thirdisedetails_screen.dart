...
class thirdisedetails_screen extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        ...
                        chapterNumber: 1,
                        tag: "Os,Mainframe,Osservice",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Process,thread&Sched",
                        chapterNumber: 2,
                        tag: "process concept,scheduling,threads",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Pro Synchronization",
                        chapterNumber: 3,
                        tag: "Synchron,deadlock prevention & recovery",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Storage Management",
                        chapterNumber: 4,
                        tag: "Swapping,contiguous allocation,paging",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "protection & security",
                        chapterNumber: 5,
                        tag: "goals,domain of protection,accessmatrix",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              "An OS is SS that manages computer hardware, software resources, and provides common services for computer programs. ",
                              maxLines: 4,
                              style: TextStyle(
                                fontSize: 10,
