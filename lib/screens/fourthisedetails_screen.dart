...
class fourthisedetails_screen extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Introduction",
                        chapterNumber: 1,
                        tag: "Introduction & charecteristics of UID",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Managing Design Pro",
                        chapterNumber: 2,
                        tag: "4 pillars of design,expert reviews",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Direct Manipulation",
                        chapterNumber: 3,
                        tag: "3D interfaces,Tele operation,Aug reality",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Command&Naturallang",
                        chapterNumber: 4,
                        tag: "Natural Lang in Computing & naming",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Quality of Service",
                        chapterNumber: 5,
                        tag: "Models of respone-time impacts",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
